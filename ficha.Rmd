...
ficha <-
    data.frame (
     ...
     descripción = c(
       ...
       paste('Diseñada: 625 <br>Ola 1 - Efectiva:',finalizadas, sep=' '),
       'Ola 1: diciembre 2020<br>Ola 2: febrero 2021',
       ...
       'Alumnos de ... <br><li>Universitat Católica de Valencia (ADE - Plan de Marketing, GECOFIN - Técnicas de Planificación Comercial)</li><li>Universitat de València (Máster en Marketing e Investigación de Mercados - Gestión de Proyectos de Investigación Comercial)</li>')
     )
